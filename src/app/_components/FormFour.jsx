  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-6 shadow-lg rounded-lg">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {["file_id", "grantha_id", "file_name", "file_path", "file_format", "folder_size_in_gb", "capture_time", "version_number", "thumbnail_url", "scan_id"].map((field) => (
          <div key={field}>
            <label className="block font-medium capitalize">{field.replace(/_/g, " ")}:</label>
            <input
              type={field.includes("time") ? "time" : field.includes("gb") || field.includes("id") ? "number" : "text"}
              className="w-full border p-2 rounded"
