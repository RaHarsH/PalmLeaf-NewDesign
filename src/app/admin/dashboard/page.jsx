...
const mockData = [
  {
    id: 1,
    sNo: '001',
    bundleOrigin: 'Tamil Nadu',
    bundleOwnerName: 'John Doe',
    bundleNumber: 'BN001',
    bundleReceivedDate: '2023-01-15',
    srivNumber: 'SRIV001',
    numbered: 'Yes',
    cleaned: 'Yes',
    scanningStartedDate: '2023-01-20',
    scanningCompletedDate: '2023-01-25',
    script: 'Tamil',
    granthaName: 'Ancient Tamil Literature',
    workedBy: 'Jane Smith',
    grayscaleCompletedDate: '2023-01-30',
    lengthCm: 30,
    widthCm: 5,
    ...
    totalImages: 100,
    folderSizeGB: 2.5,
    stitchNonStitch: 'Stitch',
    condition: 'Good',
    numberOfSubwork: 3,
    bundleSourceAddress: '123 Palm St, Chennai, India',
    horizontalVerticalS: 'Horizontal',
    directory: '/archives/tamil/BN001',
    bundleReturnedDate: '2023-02-15',
  },
]
